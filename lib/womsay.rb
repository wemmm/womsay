...
module Womsay
  ...
  class WomSayer
    ...
    def initialize
      ...
      "Can you integrate it with Trello?", "If you put a glove in the mud, the mud don't get glovey.", "Experience mediocrity.", "You can't go to a meeting if it doesn't exist.", "(ヘ･_･)ヘ┳━┳", "+｡:.ﾟヽ(´∀`｡)ﾉﾟ.:｡+ﾟﾟ+｡:.ﾟヽ(*´∀`)ﾉﾟ.:｡+ﾟ\nFOUR HOUR DEBUG SUCCESSFUL", "rails generate app ( ͡° ͜ʖ ͡°)━☆ﾟ.*･｡ﾟ"]
    end
